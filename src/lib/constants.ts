  ...
  features: {
    ...
    tabs: [
      ...
      },
      {
        ...
        description:
          "댕로그는 가족과 함께 작성하는 반려견 일기입니다.\n\n돌봄 참여자를 초대해 공동으로 기록할 수 있으며,\n매칭 여부와 관계없이 자유롭게 사용할 수 있습니다.\n\n매칭 전 상대 반려견의 일상을 확인할 수 있으며,\n쌓인 기록은 서로를 이해하고 신뢰를 쌓는 바탕이 됩니다.",
        points: [
          "반려견 일기 작성",
          "가족·돌봄 참여자 공동 기록",
          "활동 타임라인 기록",
